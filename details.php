        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="content-box">
                    ...
                    <p class="prices"><span class="current-price">Price  : $<?php echo $price_p;?></span><span class="old-price">$65</span></p>
                    ...
                    <form action="details.php?add_cart=<?php echo $id_p ?>&pid=<?php echo $id_p ?>" method="POST">
                      <div class="count">
                        ...
                        <div class="box-add-btns">
                            <input type="submit" name="add_cart" value="Add to cart" class="btn btn-danger add-cart"/>
            ...
            <div class="col-12">
                <div class="container">
                    <div class="more-details">
                        <h3>More Details</h3>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae, fuga. Laboriosam velit architecto quod neque distinctio aspernatur magni autem ipsa perferendis, laudantium similique labore, quae totam consequuntur dolorem, dolor nemo,
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae, fuga. Laboriosam velit architecto quod neque distinctio aspernatur magni autem ipsa perferendis, laudantium similique labore, quae totam consequuntur dolorem, dolor nemo!
                        </p>
                    </div>
                </div>
                                 ...
                                 ?>
                                    <div class="col-md-3">
                                        <div class="box">
                                            ...
                                            <span class="price">$<?php echo $price_p; ?></span><span class="add"><a href="details.php?pid=<?php echo $id_p; ?>">Add</a></span>
                                        </div>
                                    </div>
                                 <?php
                             }
