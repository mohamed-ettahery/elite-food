...
<div class="confirm-addr-order">
  ...
  <form action="" method="POST">
    ...
    <div class="row div-btns">
        <div class="col-6">
          <button type="submit" class="btn btn-light"><i class="fa fa-chevron-left"></i> Return</button>
        </div>
        <div class="col-6">
          <button type="submit" name="confirm" class="btn btn-danger" style="float:right;">Confirm Order <i class="fa fa-chevron-right"></i></button>            
        </div>
    </div>
  </form>
</div>
