...
if(isset($_SESSION['user']))
{
 ...
 if($_SERVER['REQUEST_METHOD'] == "POST")
 {
    if(isset($_POST['login']))
    {
        ...
        $stmt = $cnx -> prepare("SELECT CIN,Email,MDP,Nom from client WHERE Email = ? AND MDP = ? AND Active=1");
        ...
        {
            $incorrectLogin = "<p style='color:red;'>Incorrect Email/Password! or your account not approved</p>";
        }
    }
    else
    {
...
<div class="login-page">
    <div class="container">
        <h1 class="text-center login-title"><span data-class ="login" class="<?php if($action == "login"){echo "selected-login";} ?>">Login</span>|<span  data-class ="signup" class="<?php if($action == "signup"){echo "selected-signup";} ?>">Signup</span></h1>
        <!-- Start Login -->
        ...
        <div class="input-box"><input type="text"  class="form-control" name="fname" placeholder="first name" maxlength="20" autocomplete="off" required /></div>
        <div class="input-box"><input type="text"  class="form-control" name="lname" placeholder="last name" maxlength="20" autocomplete="off" required /></div>
        ...
        <div class="input-box"><input type="text"  class="form-control" name="ville" placeholder="city" maxlength="10" autocomplete="off" required/></div>
        <div class="input-box"><input type="text"  class="form-control" name="address" placeholder="Address" autocomplete="off" required/></div>
        <div class="input-box"><input type="tel"  class="form-control" name="tele" placeholder="phone" maxlength="10" autocomplete="off" required/></div>
        <div class="input-box"><input type="date"  class="form-control" name="dn" placeholder="birthday" autocomplete="off" required/></div>
        ...
        <div class="input-box"><input type="password" minlength="6" class="form-control" name="password" placeholder="password" autocomplete="new-password" required /></div>
        <div class="input-box"><input type="password" minlength="6" class="form-control" name="Conf_password" placeholder="confirm password" autocomplete="new-password" required /></div>
        <div class="input-box"><input type="submit" class="form-control btn btn-success" value="Signup"/></div>
        </form>
        <!-- End Signup -->
        <!-- Start Notices -->
